...
const minskLocations = [
  ...
  { id: 2, lat: 53.898, lng: 27.5489, title: "Парк Горького", type: "парк" },
  {
    id: 3,
    lat: 53.9341,
    lng: 27.6511,
...
const sensorData = {
    ...
    Основные: [
      {
        ...
        icon: <Building2 />,
        status: "good",
        source: "Геологическая служба",
      },
      {
        name: "Датчики деформации грунта",
        value: 76,
        icon: <Activity />,
        status: "good",
        source: "Геологическая служба",
      ...
      {
        name: "Датчики вибрации",
        value: 65,
        icon: <Activity />,
        status: "warning",
        source: "Сейсмологическая станция",
      },
      {
        name: "Датчики осадков",
        value: 88,
        icon: <Droplets />,
        status: "good",
        source: "Метеослужба",
  ...
  business: {
    Основные: [
      {
        name: "Датчик трафика и Wi-Fi трекеры",
        value: 85,
        icon: <Wifi />,
        status: "good",
        source: "Городской мониторинг",
      },
      {
      ...
      {
        name: "Датчики парковок",
        value: 45,
        icon: <Car />,
        status: "warning",
        source: "Городская служба",
      },
      {
...
const MapComponent: React.FC = () => {
  ...
  const toggleLayer = (layerId: string) => {
    ...
    toast({
      ...
      description: `Слой "${layers.find((l) => l.id === layerId)?.label}" ${
        activeLayers.includes(layerId) ? "скрыт" : "отображен"
      }.`,
    });
  };
                  ...
                  <div className="space-y-4">
                    {recommendations.length > 0 ? (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p>
                          Все показатели в норме. Локация полностью
  ...
  return (
    <div className="fixed w-full h-full flex flex-col">
      <div
        className={`map-container relative flex-1 bg-gray-100 ${mapAnimation}`}
      >
        <YMaps
          query={{
            apikey: "4d6e0acb-64c2-4348-971f-f8cfe291adfc",
            lang: "ru_RU",
          }}
        >
          <Map
      ...
      <div
        className={`absolute top-2 left-1/4 transform -translate-x-1/2 w-1/2 max-w-md px-4 ${controlsAnimation}`}
      >
        <div className="relative">
          <input
            type="text"
      ...
      {selectedLocation && (
        <FloatingCard className="absolute inset-0 flex items-center  justify-center">
          <div className="p-4 rounded shadow-lg max-w-md w-full z-100 bg-transparent">
