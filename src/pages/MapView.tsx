...
const MapView: React.FC = () => {
  ...
  return (
    <div className="absolute">
      <div className="absolute top-2 inset-1 left-2 z-10 flex ">
        <Button
          size="lg"
          onClick={() => setShowAIDialog(true)}
          className="font-bold text-lg flex items-center gap-2 h-10 w-3 rounded-lg"
        >
      ...
      <Dialog open={showAIDialog} onOpenChange={setShowAIDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="sm:justify-between">
            ...
            <Button onClick={handleProcessPrompt} disabled={processing}>
              Применить
            </Button>
          </DialogFooter>
        </DialogContent>
